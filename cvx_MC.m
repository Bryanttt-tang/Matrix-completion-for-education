...
function [Z_rec,Recover,Y_rec,Y_wc,C,cost_rec,cost_rec_binary,cost_wc,cost_wc_binary]=cvx_MC_new(Y,Z,store,observe,W,M) 
% M is Q-by-N matrix
 K=size(W,2);
...
cost_rec=norm(Z_rec-Z,'fro');
cost_rec_binary=norm(Y_rec-Y,'fro');
